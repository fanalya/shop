...
function elessi_admin_scripts() {
    ...
    wp_enqueue_script($prefix . '-admin-script', ELESSI_THEME_URI . '/admin/assets/js/nasa-script.js', array(), '5.1.8', true);
...
function elessi_admin_enqueue_style() {
    ...
    wp_enqueue_style($prefix . '-admin-style', ELESSI_THEME_URI . '/admin/assets/css/nasa-style.css', array(), '5.1.8');
