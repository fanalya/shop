...
if (!function_exists('elessi_product_detail_heading')) {
    function elessi_product_detail_heading() {
        ...
        $of_options[] = array(
            "name" => esc_html__("Single Product Options", 'elessi-theme'),
            "std" => "<h4>" . esc_html__("Single Product Options", 'elessi-theme') . "</h4>",
            "type" => "info",
            'class' => 'first'
        );
        ...
        $of_options[] = array(
            ...
            "type" => "select",
            "options" => $options,
            "desc" => esc_html__('Not use Mobile App - Simulator', 'elessi-theme')
        );
        ...
        $of_options[] = array(
            "name" => esc_html__('WooCommerce Tabs - Read more / Show less (Mobile App - Simulator)', 'elessi-theme'),
            "id" => "ns_rm_sl",
            "std" => 1,
            "type" => "switch"
        );
        ...
        $of_options[] = array(
            ...
            "std" => "<h4>" . esc_html__("Relate Products", 'elessi-theme') . "</h4>",
            "type" => "info"
        );
