...
if (!function_exists('elessi_product_page_heading')) {
    function elessi_product_page_heading() {
        ...
        $of_options[] = array(
            "name" => esc_html__("Archive Options", 'elessi-theme'),
            "std" => "<h4>" . esc_html__("Archive Options", 'elessi-theme') . "</h4>",
            "type" => "info",
            'class' => 'first'
        );
        ...
        $of_options[] = array(
            ...
            "on" => esc_html__("Yes", 'elessi-theme'),
            "off" => esc_html__("No", 'elessi-theme'),
            "std" => 0,
            "type" => "switch"
        );
        ...
        $of_options[] = array(
            "name" => esc_html__("Advance Content Options", 'elessi-theme'),
            "std" => "<h4>" . esc_html__("Advance Content Options", 'elessi-theme') . "</h4>",
            "type" => "info"
        );
