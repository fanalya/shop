...
<div class="row">
    ...
    <div class="checkout-modern-wrap large-12 columns">
        ...
        <div class="checkout-modern-left-wrap">
            ...
            <!-- Checkout Breadcrumb -->
            <nav class="nasa-bc-modern nasa-flex flex-wrap">
                ...
                <svg class="d-ltr" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="20" height="20" viewBox="0 0 32 32" fill="currentColor"><path d="M19.159 16.767l0.754-0.754-6.035-6.035-0.754 0.754 5.281 5.281-5.256 5.256 0.754 0.754 3.013-3.013z"></path></svg>
