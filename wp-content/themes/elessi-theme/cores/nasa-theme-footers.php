...
if (!function_exists('elessi_static_compare_sidebar')) :
    function elessi_static_compare_sidebar() {
        ...
        <div class="nasa-compare-list-bottom">
            <?php echo isset($nasa_opt['tmpl_html']) && $nasa_opt['tmpl_html'] ? '<template id="tmpl-nasa-mini-compare">' : ''; ?>
            
            <?php do_action('nasa_empty_mini_compare'); ?>
            
            <?php echo isset($nasa_opt['tmpl_html']) && $nasa_opt['tmpl_html'] ? '</template>' : ''; ?>
            
            <?php /* div id="nasa-compare-sidebar-content" class="nasa-relative">
