...
function nasa_register_others(){
    ...
    // **********************************************************************//
    $params = array(
        "name" => __("Testimonials", 'nasa-core'),
        "base" => "nasa_client",
        'icon' => 'icon-wpb-nasatheme',
    ...
    // **********************************************************************//
    $params = array(
        "name" => __("Contact info", 'nasa-core'),
    ...
    // **********************************************************************//
    $params = array(
        "name" => __("Opening time", 'nasa-core'),
    ...
    // **********************************************************************//
    $params = array(
        "name" => __("Countdown Time", 'nasa-core'),
        "base" => "nasa_countdown",
        'icon' => 'icon-wpb-nasatheme',
