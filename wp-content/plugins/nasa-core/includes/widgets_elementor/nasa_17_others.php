...
class Nasa_Countdown_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_name = __('Nasa Countdown', 'nasa-core');
        $this->settings = array(
            'date' => array(
                'type' => 'text',
                'std' => '',
...
class Nasa_Service_Box_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_name = __('Nasa Service Box', 'nasa-core');
        $this->settings = array(
            'service_title' => array(
                'type' => 'text',
                'std' => '',
...
class Nasa_Icon_Box_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_name = __('Nasa Icon Box', 'nasa-core');
        $this->settings = array(
            'box_img' => array(
                'type' => 'attach_image',
                'std' => '',
...
class Nasa_Image_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_name = __('Nasa Image', 'nasa-core');
        $this->settings = array(
            'image' => array(
                'type' => 'attach_image',
                'std' => '',
...
class Nasa_Icons_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_name = __('Nasa Header Icons', 'nasa-core');
        $this->settings = array(
...
class Nasa_Search_Products_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_name = __('Nasa Header Search', 'nasa-core');
        $this->settings = array(
            'el_class' => array(
                'type' => 'text',
                'std' => '',
