...
if (is_object($term) && $term) {
    ...
    <tr class="form-field nasa-term-root hidden-tag term-cat_header-type-wrap ns-advance-field">
        ...
        <td>
            ...
            echo '<option value="nasa-custom"' . ($selected == 'nasa-custom' ? ' selected' : '') . '>' . esc_html__('Header Theme Builder', 'nasa-core') . '</option>';
            echo '<option value="nasa-elm"' . ($selected == 'nasa-elm' ? ' selected' : '') . '>' . esc_html__('Header Elementor Builder', 'nasa-core') . '</option>';
            echo '</select></p>';
            ?>
        </td>
    </tr>
    ...
    <tr class="form-field nasa-term-root hidden-tag ns-advance-field">
        ...
        <td>
            ...
            echo '<option value="builder"' . ($selected == 'builder' ? ' selected' : '') . '>' . esc_html__('Builder - Suport WPBakery', 'nasa-core') . '</option>';
            
            if (NASA_ELEMENTOR_ACTIVE && NASA_HF_BUILDER) :
                echo '<option value="builder-e"' . ($selected == 'builder-e' ? ' selected' : '') . '>' . esc_html__('Builder - Support HFE-Elementor', 'nasa-core') . '</option>';
            endif;
    ...
    <div class="form-field term-cat_header-type-wrap nasa-term-root hidden-tag ns-advance-field">
        ...
        echo '<option value="nasa-custom">' . esc_html__('Header Theme Builder', 'nasa-core') . '</option>';
        echo '<option value="nasa-elm">' . esc_html__('Header Elementor Builder', 'nasa-core') . '</option>';
        echo '</select></p>';
        ?>
    </div>
    ...
    <div class="form-field nasa-term-root hidden-tag ns-advance-field">
        ...
        echo '<option value="builder">' . esc_html__('Builder - Support WPBakery', 'nasa-core') . '</option>';
        
        if (NASA_ELEMENTOR_ACTIVE && NASA_HF_BUILDER) :
            echo '<option value="builder-e">' . esc_html__('Builder - Support HFE-Elementor', 'nasa-core') . '</option>';
        endif;
