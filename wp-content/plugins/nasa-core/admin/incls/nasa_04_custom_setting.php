...
function nasa_options_woo_open($of_options = array()) {
    ...
    $of_options[] = array(
        ...
        "type" => "select",
        "options" => $blocks,
        "desc" => __("Please create Static Blocks and select here.", 'nasa-core'),
    );
    ...
    $of_options[] = array(
        "name" => __("Recommend In Archive Products", 'nasa-core'),
        "std" => "<h4>" . __("Recommend In Archive Products Page", 'nasa-core') . "</h4>",
        "type" => "info"
    );
    ...
    $of_options[] = array(
        ...
        "options" => array(
            "2-cols" => __("2 columns", 'nasa-core'),
            "1.5-cols" => __("1,5 columns", 'nasa-core'),
...
function nasa_options_promote_sales($of_options = array()) {
    ...
    $of_options[] = array(
        ...
        "std" => "<h4>" . __("Bulk Discounts Product", 'nasa-core') . "</h4>",
        "type" => "info",
        'class' => 'first'
    );
...
function nasa_options_share_follow($of_options = array()) {
    ...
    $of_options[] = array(
        "name" => __("Twitter URL Follow", 'nasa-core'),
...
function nasa_options_global_nasa_core($of_options = array()) {
    ...
    $of_options[] = array(
        "name" => __('Enable Mobile Layout', 'nasa-core'),
    ...
    $of_options[] = array(
        "name" => __("Mobile Layout Mode", 'nasa-core'),
        "id" => "mobile_layout",
        "std" => "df",
        "type" => "select",
        "options" => array(
            "df" => __("Default", 'nasa-core'),
            "app" => __("App Simulation", 'nasa-core')
        )
    );
    ...
    $of_options[] = array(
        "name" => __('CDN Images Site', 'nasa-core'),
