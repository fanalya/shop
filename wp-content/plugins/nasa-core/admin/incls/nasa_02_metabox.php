...
function nasa_meta_boxes(array $meta_boxes) {
        ...
        'fields' => array(
            array(
                ...
                'options' => array(
                    ...
                    'nasa-custom' => __('Header Theme Builder', 'nasa-core'),
                    'nasa-elm' => __('Header Elementor Builder', 'nasa-core'),
                ),
                'default' => '',
                'class' => 'nasa-core-option-parent'
            ),
            ...
            array(
                ...
                'desc' => __('Header sticky (Not use for Header Builder).', 'nasa-core'),
                'id' => $prefix . 'fixed_nav',
                'type' => 'select',
                'options' => array(
                    '' => __('Default', 'nasa-core'),
            ...
            array(
                ...
                'desc' => __('Override Text color items in header', 'nasa-core'),
            ...
            array(
                ...
                'desc' => __('Override Text color hover items in header', 'nasa-core'),
            ...
            array(
                ...
                'desc' => __('Override text color items in top bar', 'nasa-core'),
            ...
            array(
                ...
                'desc' => __('Override Text color hover items in Top bar', 'nasa-core'),
            ...
            array(
                ...
                'desc' => __('Override background color for Main menu', 'nasa-core'),
            ...
            array(
                ...
                'desc' => __('Override text color for Main menu', 'nasa-core'),
            ...
            array(
                ...
                'desc' => __('Override Vertical Menu Background - Focus', 'nasa-core'),
            ...
            array(
                ...
                'desc' => __('Override Vertical Menu Text Color - Focus', 'nasa-core'),
    ...
    $modes["builder"] = __("Builder - Suport WPBakery", 'nasa-core');
